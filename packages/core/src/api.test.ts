...
describe("makeApi", () => {
  it("should throw on duplicate path", () => {
    ...
    ).toThrowError("Zodmon: Duplicate path 'get /users'");
  });
  ...
  it("should throw on duplicate alias", () => {
    ...
    ).toThrowError("Zodmon: Duplicate alias 'getUsers'");
  });
  ...
  it("should throw on duplicate Body", () => {
    ...
    ).toThrowError("Zodmon: Multiple body parameters in endpoint '/users'");
  });
